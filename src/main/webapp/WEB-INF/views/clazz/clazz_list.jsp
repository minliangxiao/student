    ...
    <form id="addForm" method="post">
        <table id="addTable" cellpadding="8">
            <tr>
                ...
                <td>
                    <input id="add_name" class="easyui-textbox" style="width: 200px; height: 30px;" type="text"
                           name="name" data-options="required:true,  missingMessage:'请输入班级名'"/>
                </td>
            ...
            <tr>
                <td>所属年级:</td>
                <td>
                    <select id="add_gradeId" class="easyui-combobox" style="width: 200px;" name="gradeId"
