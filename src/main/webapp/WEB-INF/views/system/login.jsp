...
<script type="text/javascript">
	$(function(){
		...
		$("#vcodeImg").click(function(){
			this.src="get_cpacha?v1=4&w=160&h=40&t="+new Date().getTime();
		});
		
		//登录
		$("#submitBtn").click(function(){
			var data = $("#form").serialize();//包装表格数据表达序列化
			$.ajax({
				type: "post",
				url: "login",
				data: data, 
				...
				success: function(data){
					if("success"==data.type){
					    window.parent.location.href="index";//prarent表示再父框架里展示登陆页面
                    }else {
					    $.messager.alert("消息提示",data.msg,"warning")//弹出提示框
...
<div class="footer">Copyright &nbsp; artisan @ [小良] </div>
