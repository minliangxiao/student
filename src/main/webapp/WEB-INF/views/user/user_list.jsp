	...
	<div id="addDialog" style="padding: 10px;">  
   		...
   		<form id="addForm" method="post">
	    	<table id="addTable" cellpadding="8"  >
	    		...
	    		<tr>
	    			<td>密码:</td>
	    			<td><input id="add_password" style="width: 200px; height: 30px;" class="easyui-textbox" type="pas`sword" name="password" data-options="required:true, missingMessage:'请填写密码'" /></td><%--required:true表示必须填不然就显示储提示信息--%>
	    		</tr>
